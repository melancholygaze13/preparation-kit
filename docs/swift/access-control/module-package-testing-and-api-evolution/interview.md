...
Precise testing boundary semantics.
...
- What build setting is required?
- How would you test private behavior?

### Strong Answer Signals

- Limits exposure to internal and testing builds.

### Weak Answer Signals

- Calls it public access for tests.
...
Source API versus optimization/ABI surface.
...
- Does usable-from-inline make a symbol public?
- Can an inlinable body reference private state?

### Strong Answer Signals

- Separates source access, ABI, and optimizer opportunity.

### Weak Answer Signals

- Treats inlinable as a guaranteed speed flag.
...
Principal-level dependency and compatibility planning.

### Short Answer

Inventory actual consumers, define new owners/layers, classify declarations as private/internal/package/public,
add facades or forwarding shims, compile all client classes, migrate dependency edges in stages, measure
build/binary effects, then deprecate/remove old surfaces with rollback.
...
- How would you detect dependency cycles?
- Which symbols need compatibility shims?

### Strong Answer Signals

- Covers ownership, layering, clients, measurement, and rollback.

### Weak Answer Signals

- Changes internal to public until compilation succeeds.
