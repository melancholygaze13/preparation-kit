...
Ability to reason from ownership rather than lexical appearance.
...
- Why can a temporary lifetime extension be correct?
- How would you verify the actual root?

### Strong Answer Signals

- Enumerates nonlocal roots and cycles.
- Separates optimizer placement from semantics.

### Weak Answer Signals

- Says objects always deallocate at the closing brace.
...
Reference binding and ownership fundamentals.
...
- Does `let` contribute a strong reference?
- How do class and struct aliases differ?

### Strong Answer Signals

- Separates binding, identity, mutation, and ownership.

### Weak Answer Signals

- Calls `let` a weak or deeply immutable reference.
...
Production judgment about memory and observable shutdown.
...
- What cleanup is appropriate in `deinit`?
- How should shutdown ownership be tested?

### Strong Answer Signals

- Mentions async/error limitations and cycles.
- Proposes explicit ownership.

### Weak Answer Signals

- Uses `deinit` for required network completion.
