---
title: "Numeric Types and Conversions"
domain: "Swift"
...
> A numeric type defines range and precision. Swift requires explicit conversion
> between stored numeric types so possible loss remains visible.
