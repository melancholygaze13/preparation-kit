...
> the subtype, including required rules, failures, effects, ordering, and isolation.

## Quick Recall

- Do not strengthen accepted-input requirements or weaken promised results.
- Preserve required rules, failure categories, side-effect order, repeat-call behavior,
